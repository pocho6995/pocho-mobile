...
class CarService {
  ...
  final String category; // "СТО", "Автосервис", "Шиномонтаж" и т.д.
  final List<String> services; // ["Ремонт двигателя", "Замена масла", "Диагностика"]
  ...
  final List<String> features; // ["Парковка", "Кафе", "Wi-Fi", "Ожидание"]
  final String? phone;
